...
export const metadata: Metadata = withLocaleAlternates('es', 'home', {
  ...
  openGraph: {
    ...
    images: [{ url: `${siteConfig.url}/images/chef-ilhama-social.jpg`, width: 1200, height: 630, alt: 'Chef İlhamə — Cocina azerbaiyana' }],
  },
  twitter: {
